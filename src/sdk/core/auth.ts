...
// ✅ Only force unauthenticated if BOTH:
// - status is still loading
// - AND there is truly NO token
if (currentStatus === "loading" && !token) {
  console.log(
    "Auth initialization complete - no token found, setting to unauthenticated",
  );
