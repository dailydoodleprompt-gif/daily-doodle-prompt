    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '48px', fontWeight: 700, color: '#1c1917', marginBottom: '30px' }}>
            {username}
          </div>

          <div style={{ display: 'flex', gap: '40px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <span style={{ fontSize: '40px', fontWeight: 700, color: '#f17313' }}>{doodles}</span>
              <span style={{ fontSize: '18px', color: '#78716c' }}>Doodles</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <span style={{ fontSize: '40px', fontWeight: 700, color: '#f17313' }}>🔥 {streak}</span>
              <span style={{ fontSize: '18px', color: '#78716c' }}>Day Streak</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <span style={{ fontSize: '40px', fontWeight: 700, color: '#f17313' }}>{badges}</span>
